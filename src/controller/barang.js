...
const insertBarang = async (req, res) => {
  try {
    ...
    if (req.files["gambar_1"])
      body["gambar1_barang"] = "/images/" + req.files["gambar_1"][0].filename;
    if (req.files["gambar_2"])
      body["gambar2_barang"] = "/images/" + req.files["gambar_2"][0].filename;
    if (req.files["gambar_3"])
      body["gambar3_barang"] = "/images/" + req.files["gambar_3"][0].filename;
